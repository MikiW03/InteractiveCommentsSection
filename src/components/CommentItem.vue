<template>
    <div>
        <div class="comment-card">
            ...
            <ScoreItem class="comment-score" :score="score" />
            <button class="comment-delete" v-if="isUserCurrent(user, currentUser)"><img src="images/icon-delete.svg"
            ...
            <button class="comment-reply-edit" v-else><img src="images/icon-reply.svg" alt="reply icon">
                Reply</button>
